package com.dhht.util.face.demo;
...
import com.dhht.util.face.sdk.*;
import com.dhht.util.face.utils.BufferInfo;
import com.dhht.util.face.utils.ImageLoader;
...
public class AFRTest {
    ...
    public static final boolean bUseBGRToEngine = true;
       ...
       public  float  compareImage(String filePathA,String filePathB){
        ...
        if (bUseRAWFile) {
             filePathA = "001_640x480_I420.YUV";
            int yuv_widthA = 640;
            int yuv_heightA = 480;
            int yuv_formatA = ASVL_COLOR_FORMAT.ASVL_PAF_I420;

             filePathB = "003_640x480_I420.YUV";
            int yuv_widthB = 640;
            int yuv_heightB = 480;
        ...
        Float similarity  = compareFaceSimilarity(hFDEngine, hFREngine, inputImgA, inputImgB);
           if(similarity*100<45){
               System.out.println("相识度为"+similarity*100);
           }else{
               System.out.println("相识度为"+similarity*100);
           }
        // release Engine
