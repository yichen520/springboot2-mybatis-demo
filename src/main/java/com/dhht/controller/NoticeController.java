...
public class NoticeController {
    ...
    public JsonObjectBO upload(@RequestBody Notice notice, @RequestParam("file") MultipartFile[] multipartFiles, HttpServletRequest httpServletRequest){
    ...
    public JsonObjectBO insert(@RequestBody Map map,HttpServletRequest httpServletRequest){
        User user = (User)httpServletRequest.getSession().getAttribute("user");
        return ResultUtil.getResult(noticeService.insert(map,user));
    }
    ...
    public JsonObjectBO show(HttpServletRequest httpServletRequest){
        ...
        try{
            jsonObject.put("notice",noticeService.selectByNum(user.getDistrictId()));
